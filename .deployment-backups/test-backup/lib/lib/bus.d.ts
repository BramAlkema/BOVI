...
export declare const emit: <K extends keyof BoviEventMap>(
  type: K,
  detail: BoviEventMap[K],
  options?: {
    bubbles?: boolean;
...
export declare const on: <K extends keyof BoviEventMap>(
  type: K,
  listener: (event: CustomEvent<BoviEventMap[K]>) => void,
  options?: AddEventListenerOptions
) => void;
export declare const off: <K extends keyof BoviEventMap>(
  type: K,
  listener: (event: CustomEvent<BoviEventMap[K]>) => void,
  options?: EventListenerOptions
) => void;
export declare const once: <K extends keyof BoviEventMap>(
  type: K,
  listener: (event: CustomEvent<BoviEventMap[K]>) => void
) => void;
export declare const onBoviMode: (
  mode: "V" | "I" | "B" | "O",
