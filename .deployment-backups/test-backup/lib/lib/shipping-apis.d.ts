...
export declare function createHamburgerBasket(
  name: string,
...
export declare function calculateMoneyVeil(
  income: number,
  savings: number,
  interestRate: number
...
export declare function createSmartContract(
...
export declare function createCohortAuction(
  category: string,
  targetSize?: number
...
export declare function createStormProfile(
  profile: Omit<StormProfile, "id">
): Promise<StormProfile>;
