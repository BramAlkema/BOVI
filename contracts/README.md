...
| [`SYSTEM-DYNAMICS.md`](SYSTEM-DYNAMICS.md) | — | **the cast as a system**: stocks, flows, and where each loop closes. Two closed loops on-chain, both balancing, both in `Kocherlakota`; every other loop routes through an oracle, a reporter, or a person | **reference** |
