...
class DeploymentValidator {
  ...
  validateHTML() {
    ...
    if (
      !html.includes("initTradeSimulation") ||
      !html.includes("stepTradeSimulation") ||
      !html.includes("attemptMoney") ||
      !html.includes("attemptTally")
    ) {
    ...
    if (
      !html.includes("launchHouseholdInstruments") ||
      !html.includes("renderBasket") ||
      !html.includes("renderSubscriptions")
    ) {
      this.errors.push("HTML missing Household Instruments interaction handlers");
    }

    if (
      !html.includes("launchBundleBuilder") ||
      !html.includes("generatedClause") ||
      !html.includes("renderMix")
    ) {
      this.errors.push("HTML missing Bundle Builder interaction handlers");
    }

    if (
      !html.includes("launchSystemLab") ||
      !html.includes("renderBugMatrix") ||
      !html.includes("renderSystemOutput")
    ) {
  ...
  validateCSS() {
    ...
    const criticalStyles = [".mode-badge", ".panel", ".scenario"];
    ...
    if (stats.size < 5000) {
      // Less than 5KB is probably incomplete
  ...
  validateJS() {
    ...
    const criticalFunctions = ["BoviApp"];
    ...
    if (stats.size < 10000) {
      // Less than 10KB is probably incomplete
