...
import { createCohortAuction, joinCohortAuction, getActiveAuctions } from '../services/cohort-auctions.js';
...
function updateCohortDisplays(): void {
  ...
  opportunities.forEach(opportunity => {
    ...
    if (participantsEl) participantsEl.textContent = Math.floor(Math.random() * 100 + 20).toString();
