...
**"The price is the price."** The mode of strangers, spot trade, and instrumental exchange. Mapped from Fiske's **Market Pricing**.

Two strangers, one transaction, fairness = the number both agree on. No history, no relationship, no obligation. Just: would you pay X? would you take X? deal.

## Where it works

- Apps for strangers: Vinted, Uber, DoorDash, Steam, App Store, Spotify, Netflix
...
The only fair question is **"is the price right?"**

Not: "is it right that they're charging?"
Not: "what do I owe them beyond this?"
...
- **Personalised pricing** (Amazon, e-commerce)
- **Surveillance pricing** (insurance based on social media)
- **Algorithmic price discrimination** (postcode-based, browser-fingerprint-based)
- **Yield management** generally (see [yield management analysis](../pathologies/yield-management.md))
...
> "Market Pricing (MP): Resources flow proportional to some ratio or rate; Fairness Logic: 'Value for value' / 'Proportional contribution'; Emotional Signature: Efficiency, rationality, optimization; Violations Feel: Irrational, wasteful." — `theory.md`

## See also

- [Four Modes Overview](../core/four-modes-overview.md)
- [Adversarial Mode Forcing](../pathologies/adversarial-mode-forcing.md) — coerced Value at scale
- [Yield Management](../pathologies/yield-management.md) — Value mode without other-mode constraints
- [Buyer-Obfuscation Arms Race](../pathologies/buyer-obfuscation-arms-race.md) — Value mode amplified by AI
