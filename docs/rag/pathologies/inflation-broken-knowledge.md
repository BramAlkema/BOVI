---
title: Inflation as Broken Common Knowledge
type: pathology
...
- Quality adjustments and substitution methods compound the divergence
- The state has no incentive to publish the inconvenient number

**Personal indices (the Big Mac, your notebook, the basket of things you actually buy) are more honest than institutional measures** because they cannot be politically manipulated at the personal scale.

## The Big Mac War: a worked example

In 2011, the Argentine government ordered McDonald's to sell the Big Mac at half the price of the other burgers on the menu. McDonald's complied. The Big Mac quietly disappeared from menu boards and advertising. The state had weaponised silence against an index in a British magazine.
...
## What broken common knowledge looks like in practice

Stages of a currency under stress:

1. **Anchor wobble**: official statistics diverge from lived experience; personal indices and headline CPI part ways
2. **Network fray**: shopkeepers stop accepting the local currency for big items; landlords want dollars; capital controls appear
3. **Function migration**: store-of-value moves first (USD/gold/USDT/real estate); unit-of-account follows (rent in dollars even though paid in pesos); medium-of-exchange last (pesos still used for bread)
4. **Local currency reduces to its Obligated floor**: residents hold only what's needed for tax; everything else escapes the currency

This is the **dollarisation pattern**, and it has played out in Weimar, Zimbabwe, Argentina, Lebanon, Venezuela, and dozens of other cases. See [Argentina case](../cases/argentina-bigmac-dollarisation.md).

## The inversion of Gresham's Law
...
When evaluating any currency situation, ask:

> **Is common knowledge of supply still intact?**

If yes: the currency is functional, even if individual prices are noisy.
...
- State suppression of independent measurement
- Residents holding wealth in foreign currency

## See also

- [Common Knowledge of Acceptance](../core/common-knowledge-of-acceptance.md) — what fails when inflation runs
- [Argentina: Big Mac War & Dollarisation](../cases/argentina-bigmac-dollarisation.md) — full case
- [Weimar Hyperinflation](../cases/weimar-hyperinflation.md) — historical case
- [Personal Indices](../practice/personal-indices.md) — the defensive practice
- [Five Axioms](../core/five-axioms.md) — what gets violated
