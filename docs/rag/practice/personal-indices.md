---
title: Personal Indices
type: practice
tags: [index, big-mac, basket, purchasing-power, defensive-practice]
sources: [conversation-derived]
related: [personal-pda.md, unbundled-personal-stack.md, ../cases/argentina-bigmac-dollarisation.md]
---
...
(Argentina tried — see [Big Mac War case](../cases/argentina-bigmac-dollarisation.md). The state ordered McDonald's to lose money on every Big Mac sold to mask inflation. It worked for a year, then collapsed in a 26% one-day price jump after the suppression was exposed.)

## Building your own personal index

Pick 5–10 items you actually buy regularly. Examples for a 20-something European:

- A flat white at your usual place
- Big Mac (or your equivalent fast-food benchmark)
- Monthly transit pass
- An hour of co-working WiFi
- A haircut
- A standard supermarket basket (bread, milk, eggs, X)
- A typical takeaway / delivery
- A pint at your local
- A Spotify / Netflix subscription
- Your share of monthly rent

That's your index. It moves with your actual purchasing power, not the government's preferred number.
...
Once a personal index is installed:

1. You stop trusting any single price tag in isolation
2. You stop being anchored by sellers' framing
3. You can detect surveillance pricing
4. You can detect shrinkflation
5. You can compare your own purchasing power across years honestly
6. You can challenge official statistics from a position of evidence
7. You stop being a passive consumer of price signals

## See also

- [Personal PDA](personal-pda.md) — the tool that holds the index
- [Unbundled Personal Stack](unbundled-personal-stack.md) — where indices fit
- [Argentina: Big Mac War & Dollarisation](../cases/argentina-bigmac-dollarisation.md) — institutional index manipulation
- [Inflation as Broken Common Knowledge](../pathologies/inflation-broken-knowledge.md) — why personal measurement matters
- [Four Functions](../architecture/four-functions.md) — index = unit of account, separated from medium of exchange
