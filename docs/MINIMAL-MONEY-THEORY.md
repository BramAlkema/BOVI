# Minimal Money Theory: The Portable Forgetful Ledger

## Core Definition

**Minimal Money**: The simplest possible system that enables exchange by unlocking otherwise-impossible trades.

It is fundamentally a **portable forgetful ledger** - a distributed record of who has what now, with no memory of how they got it.
...
**NOT a unit of account**: Prices fluctuate too wildly for human memory. That's what PDAs are for.

**NOT a store of value**: Holding it means missing returns from productive assets. That's what stocks/bonds are for.
...
4. Everything else (unit of account, store of value) belongs elsewhere

## The Proper Stack

Instead of forcing money to do everything:
...
Social Layer: Gift networks (non-market resource flows)
```

## Why This Matters for BOVI
...
This gives BOVI the perfect teaching sequence:

**Episode 1**: Start with minimal money - just a portable forgetful ledger
**Episode 2**: Watch problems emerge as we try to use it
**Episode 3**: See how each problem spawns a new fairness mode
**Episode 4**: Understand why all money becomes a bundle
**Episode 5**: Learn to consciously design bundles instead of accepting default ones

## The Bottom Line

**Minimal money proves that "pure" economic exchange is impossible.** The moment you create even the simplest trading token, you spawn debt tracking, authority structures, and social obligations.

Money's bundling isn't a bug - it's the inevitable result of humans needing to exchange value across different relationship types and time horizons.

The BOVI framework doesn't fight this reality - it makes it conscious and navigable.
