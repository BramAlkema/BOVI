...
## A · The personal stack — you, alone, defended
...
You start a Tally inside a conversation you are already having. It rides on the chat apps where the group already lives — the WhatsApp thread, the iMessage group, the Signal chat — because a fresh ledger with nobody on it is worth nothing (the cold-start that killed Hayek's perfect money). It **borrows its network** rather than begging for one. Add the people; agree, lightly, to tag honestly; trade; and let the canvas net the circle on its own. Entering a Tally with someone is a small but real act — a relationship-defining commitment to keep a shared, mode-aware account and to be truthful together about which mode each thing belonged to. That honesty is the product. The maths is trivial; the agreement is everything.

### Where it fits

A flatshare (rent **O**, the shared shop **B**, the night someone cooked for everyone **I**). A friend group on a trip. A couple keeping the joint things visible without pricing the relationship. A festival squad. A band splitting its takings. Anywhere a handful of people exchange enough, often enough, that memory frays and Splitwise would lie.
...
## C · The seven questions — read any money in thirty seconds

When something lands in front of you — a banknote, a token, a gift card, a subscription, a salary, a "convenience fee," a workplace that calls itself a family — run the card:
...
7. **Door.** Who owns the guaranteed acceptor at its edge — the tax office that must take it, the loan desk that calls it home — and what do they charge? The service is real; the bill should be itemized.

And beneath all seven: **which way does the worth flow** — pushed from what stands behind it, or pulled by the next trade it unlocks? If the sales pitch answers "pushed," you have found the essentialism; every other line on this card follows from refusing it.
