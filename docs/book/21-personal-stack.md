...
> *You can build your own unbundled architecture using tools that already exist.*
...
A young European tourist pulls a notebook out of her backpack at a café in Buenos Aires and writes down: *Big Mac €3.20, flat white €2, transit pass €8, haircut €4, share of room €120/wk*. Her first personal index. No app required.
...
We spent a chapter establishing that headline inflation figures are aggregates you cannot trust and cannot check. The personal index is the answer, and its power is precisely that it is too small and too specific to be corrupted. Nobody can lean on *your* basket. Over a few months it tells you things no official statistic will: that your rent is rising faster than the index admits, that the "same" cereal box quietly lost forty grams, that the streaming subscription crept up at renewal while you were not looking. It turns you from a passive recipient of prices into someone who *knows what things cost* — the single most effective defence against every trick a price tag can play. Anchoring, where the first number you see sets your sense of fair: defeated, because you brought your own number. Surge and "personalised" pricing: visible, because you know the baseline. The discount that is not really a discount: exposed. A person with a price memory cannot be told what things cost, and that refusal is most of the war.

### Four pots, one phone

The second piece is the wealth stack, and it is just as humble. Doña Elena's genius was not access to exotic instruments; it was *separating the jobs.* You can do the same with whatever you already have, in four notional pots.
