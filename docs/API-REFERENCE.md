...
```typescript
import { createHamburgerBasket, calculateHamburgerInflation } from "./lib/services/hamburger.js";
...
```typescript
import { pluginManager, pluginRegistry, registerBuiltInPlugins } from "./lib/plugins/index.js";
...
jest.mock("./lib/services/rulers.js", () => ({
  getRulers: jest.fn().mockResolvedValue([{ id: "test-ruler", name: "Test Ruler", bpDrift: 0 }]),
}));
